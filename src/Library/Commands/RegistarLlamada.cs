...
// ReSharper disable once UnusedType.Global
    public class RegistrarLlamada : ModuleBase<SocketCommandContext>
    {
        ...
        [Summary(
            "Registra la llamada y devuelve una confirmacion de la llamada creada en caso de que asi sea, en caso opuesto devuelve un error y su explicacion")]
        ...
        public async Task ExecuteAsync([Remainder][Summary("xxx")]string parametros)
        {
            ...
            {
                string mensaje = fachada.RegistrarLlamada(parte[0], parte[1], parte[2], parte[3], parte[4]);
