...
// ReSharper disable once UnusedType.Global
    public class RegistrarVentaComando : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task ExecuteAsync([Remainder][Summary("xxx")]string parametros)
        {
            ...
            if (parte.Length != 5)
            {
                await ReplyAsync($"Se nececitan 5 parametros(clienteId,producto,fecha,precio,usuarioId). Recurda separar los parametros por ','");
