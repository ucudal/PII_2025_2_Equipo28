...
namespace Ucu.Poo.DiscordBot.Commands
{
    ...
    /// <summary>
    /// Esta clase agrega a una lista al cliente el cual se puso en contacto con el usuario y este aun no le responde.
    /// Devuele la confirmacion de si se hizo o no.
    /// </summary>
// ReSharper disable once UnusedType.Global
    public class ClienteContactoaAgregarComando : ModuleBase<SocketCommandContext>
    {
