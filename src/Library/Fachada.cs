...
namespace Library
{
    ...
    {
        public RepoClientes RepoClientes = new RepoClientes();
            ...
            string usuarioId, string cuando)
        {
            ...
            try
            {
                ...
                cliente = RepoClientes.BuscarUnCliente(clienteId);
            ...
            string precio, string usuarioId)
        {
                ...
                string tipo = "")
            {
                ...
                if (usuario != null)
                {
                    Cliente cliente = RepoClientes.BuscarUnCliente(clienteNombre, clienteApellido);
                    if (cliente != null)
                    {
...
//{
        ...
        string apellidoCliente)
    {
        ...
        Cliente cliente = RepoClientes.BuscarUnCliente(nombreCliente, apellidoCliente);
    ...
    public void VerPanelResumen(string usuarioId)
    {
        ...
        if (usuario != null)
        {
            ...
            // Clientes totales
            Console.WriteLine("Clientes totales: " + RepoClientes.Clientes.Count);
    ...
    {
        return RepoClientes.BuscarCliente(atributo, valorBusqueda);
    }
    ...
    {
        Cliente cliente = RepoClientes.BuscarCliente("id", id)[0];
